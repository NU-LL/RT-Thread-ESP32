...
BaseType_t xQueueTakeFromISR( QueueHandle_t xQueue, BaseType_t * const pxHigherPriorityTaskWoken ) PRIVILEGED_FUNCTION;//新添 --jz
/**@}*/
 ...
 * 所以不建议用户直接调用
 */
BaseType_t xsemaphore_give(QueueHandle_t xSemaphore) PRIVILEGED_FUNCTION;
BaseType_t xsemaphore_take(QueueHandle_t xSemaphore, TickType_t xBlockTime) PRIVILEGED_FUNCTION;
/** @endcond */
